    ...
    <div style={{ minHeight: '100vh', background: '#030712', padding: '24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ ...sec, border: '1px solid #1E3A5F' }}>
          ...
          <RuleBuilder title="청산 조건" excludeRuleTypes={["TEST_FORCE_ENTRY_ONCE"]} rules={form.params.exitRules} warnUnused showWeight={false} onChange={r => setParam('exitRules', r)} />
          <RuleBuilder title="차단 조건" excludeRuleTypes={["TEST_FORCE_ENTRY_ONCE"]} rules={form.params.blockRules} showWeight={false} onChange={r => setParam('blockRules', r)} />
        </div>
